          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-8 md:p-12 border-b lg:border-b-0 lg:border-e border-border">
              <form className="space-y-6">
                ...
                <button
                  type="button"
                  className="w-full md:w-auto px-8 py-4 bg-button-primary text-button-primary-text font-bold rounded-xl hover:bg-button-primary-hover transition-all transform hover:-translate-y-1 shadow-lg shadow-button-primary/20"
                >
                  {t("send")}
                </button>
              </form>
            ...
            {/* Contact Info Panel */}
            <div className="w-full lg:w-[400px] bg-surface-container p-8 md:p-12 space-y-12 rounded-xl border border-border">
              ...
              <ul className="space-y-8">
                <li className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-surface rounded-xl shadow-sm flex items-center justify-center flex-shrink-0 border border-border">
                    <FontAwesomeIcon
                      icon={faLocationDot}
