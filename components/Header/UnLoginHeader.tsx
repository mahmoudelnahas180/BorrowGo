    ...
    <header className="bg-bg/80 backdrop-blur-md sticky top-0 left-0 right-0 w-full text-text-primary z-50 border-b border-border shadow-sm">
      <div className="container mx-auto px-4 lg:px-8 h-20 flex justify-between items-center relative">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <Link
            href="/login"
            className="px-5 py-2 rounded-lg text-sm font-medium text-button-secondary-text bg-button-secondary hover:bg-button-secondary-hover transition-colors">
            {t("login")}
          </Link>
          <Link
            href="/register"
            className="px-5 py-2 rounded-lg text-sm font-medium text-button-primary-text bg-button-primary hover:bg-button-primary-hover transition-colors">
            {t("register")}
          </Link>
        </div>
